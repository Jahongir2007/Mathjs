...
$(document).ready(function(){
    ...
    var get_mathjs = $("!import:math.js").html("<script src='mathjsv1.8.6.js'></script>");
    var get_mathjs = $("!import:others").html("<script src='https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js'></script>");
    if(get_attr == "sqrt"){
